...
public class CreateProfileHandler implements MessageHandler<ProfileDto> {
  ...
  public void handleMessage(ProfileDto message) {
    ...
    } catch (DataValidationException | DuplicateEmailException e) {
      log.error("Failed to create profile: {}", profile, e);
    }
  }
}
